import datetime
import uuid
from sqlalchemy import Column, String, Integer, Boolean, DateTime, ForeignKey, Index, JSON, Float, Text, Enum
...
class Comment(Base):
    ...
    content = Column(Text, nullable=False)
    status = Column(Enum("open", "resolved", name="comment_status"), default="open")
